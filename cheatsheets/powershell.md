...
Create new item| `New-Item <Name>`| `mk,dir, touch`|
Manage proceses| `Get-Process, Stop-Process`| |
...
> 
> *(Source: [Interview](https://everone.com/blog/jeffrey-snover-interview) with Jeffrey Snover, PowerShell Inventor)* 
